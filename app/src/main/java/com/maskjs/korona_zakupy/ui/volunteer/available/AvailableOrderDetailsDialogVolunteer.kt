...
class AvailableOrderDetailsDialogVolunteer(
    ...
    override fun initialize(context: Context) {
        this.dialogView = LayoutInflater.from(context).inflate(R.layout.available_order_details_popup, null)
        val builder = AlertDialog.Builder(context)
            .setView(dialogView)
            .setTitle(R.string.order_details)

        this.alertDialog = builder.show()
        this.productsListView = dialogView.productsVolunteerAvailableLV
        this.addressTextView = dialogView.addressVolunteerAvailableTV
        this.dateTextView = dialogView.dateVolunteerAvailableTV
    }
